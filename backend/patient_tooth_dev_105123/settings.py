"""
Django settings for patient_tooth_dev_105123 project.
...
ROOT_URLCONF = 'patient_tooth_dev_105123.urls'
...
WSGI_APPLICATION = 'patient_tooth_dev_105123.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_tooth_dev_105123 API",
    "DESCRIPTION": "API documentation for patient_tooth_dev_105123 App",
    "VERSION": "v1",
}
